     ...
     <div className='container'>
      ...
      >
        ...
        <SwiperSlide>
            ...
            <Image  className='cardimage' src={ijm}  class="img-fluid rounded-circle"/>
        ...
        <SwiperSlide>
            <div class="card">
                ...
                <div class="card-body">
                <Image  className='cardimage' src={fathil}  class="img-fluid rounded-circle"/>
        ...
        <div class="card">
            <div class="card-body">
            <Image  className='cardimage' src={iuiu}  class="img-fluid rounded-circle"/>
        ...
        <div class="card">
            <div class="card-body">
            <Image  className='cardimage' src={pride}  class="img-fluid rounded-circle"/>
        ...
        <div class="card">
            <div class="card-body">
            <Image  className='cardimage' src={olympic}  class="img-fluid rounded-circle"/>
        ...
        <SwiperSlide>
            <div class="card">
                <div class="card-body">
                <Image  className='cardimage' src={ku}  class="img-fluid rounded-circle"/>
        ...
        <div class="card">
            <div class="card-body">
            <Image  className='cardimage' src={npa}  class="img-fluid rounded-circle"/>
